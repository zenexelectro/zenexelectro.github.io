            ...
            <div className="container flex h-16 max-w-screen-2xl items-center px-4 md:px-8">
              <div className="mr-4 flex w-full justify-between items-center md:justify-start">
                <a className="mr-2 sm:mr-6 flex items-center space-x-2" href="/">
                  <span className="font-bold inline-block text-lg sm:text-xl tracking-tight">
                    ZENEX<span className="text-muted-foreground font-light hidden sm:inline">SYSTEMS</span>
                  </span>
                </a>
                <nav className="flex items-center gap-3 sm:gap-4 md:gap-6 text-[11px] sm:text-xs md:text-sm">
